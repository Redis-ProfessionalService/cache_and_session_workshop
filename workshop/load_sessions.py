...
VISITED = ['www.megashop.com','www.whatever.org','redis.io','mail.example.com','duckduckgo.com','www.example.shop','redis.io','google.com','www.example.com','www.discover.com','portal.discover.com']
...
class LoadSessions():
    ...
    def load_premade():
        ...
        redis.json().set('session:3', Path.root_path(), '{"lastAccessed":1723574040,"creation":1723572000,"user": {"firstname":"Paul","lastname":"Bunion"},"visited":["www.megashop.com","www.whatever.org","www.discover.com"], "location": "-87.6359,41.8788", "cart":[{"itemId":"bigaxe","itemCost":918.99,"quantity":2}]}' )
        redis.json().set('session:4', Path.root_path(), '{"lastAccessed":1723572101,"creation":1723568404,"user": {"firstname":"Carl","lastname":"Llama"},"visited":["redis.io","portal.discover.com"], "location": "-87.605,41.892"}' )
    ...
    def load_session(how_many):
        ...
        def get_create_time():
            # returns a random time between midnight (2:00:00 pm, Aug 13, 2024) and the beginning of this workshop (14:00:00)
